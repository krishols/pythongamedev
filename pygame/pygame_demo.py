...
# load image surface object (frog)
frog = pygame.image.load("frog sprite.png")

# load image surface object (counter)
counter = pygame.image.load("counter_sprite.png")
...
"""
frogrect = frogrect.move(350, 700)
# frogrect.move_ip
...
for x in range(100):
    screen.blit(background, frogrect, frogrect)
    old = frogrect
    frogrect = frogrect.move(10,0)
    screen.blit(frog, frogrect)
    pygame.event.get()
    pygame.display.update([old,frogrect])
